...
;layui.define("form", function (e) {
    ...
    var i = layui.$, a = layui.form, n = "tree", r = {
        ...
        o = "layui-icon-triangle-r", h = "layui-icon-triangle-d", u = "layui-tree-entry", f = "layui-tree-main",
        ...
        layui.each(l, function (a, l) {
            var c = l.children && l.children.length > 0,
                ...
                h = i(['<div data-id="' + l.id + '" class="layui-tree-set' + (l.spread ? " layui-tree-spread" : "") + (l.checked ? " layui-tree-checkedFirst" : "") + '">', "<div " + (r.drag && !l.fixed ? 'draggable="true"' : "") + ' class="layui-tree-entry">', '<div class="layui-tree-main">', function () {
                    return r.showLine ? c ? '<span class="layui-tree-iconClick layui-tree-icon"><i class="layui-icon ' + (l.spread ? "layui-icon-triangle-d" : "layui-icon-triangle-r") + '"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-icon layui-icon-file"></i></span>' : '<span class="layui-tree-iconClick"><i class="layui-tree-iconArrow ' + (c ? "" : t) + '"></i></span>'
                }(), function () {
